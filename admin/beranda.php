...
$pelamar = query("
      ...
      where konfirmasi.satus_konfirmasi='Di Terima'
      group by nik 
        ...
        <nav class="navbar-color gradient-45deg-light-blue-cyan">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <h1 class="logo-wrapper">
                  <a href="beranda.php">
                    <img src="images/logo/perhubungan-logo.png" alt="materialize logo">
            ...
            <ul id="profile-dropdown" class="dropdown-content">
              ...
              <li>
                <a href="logout_admin.php" class="grey-text text-darken-1">
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <ul class="collapsible" data-collapsible="accordion">
                <li class="bold">
                  <a href="beranda.php?page=konfirmasi.php" class="waves-effect waves-cyan">
                ...
                <ul class="collapsible" data-collapsible="accordion">
                <li class="bold">
                  <a href="beranda.php?page=laporan/report.php" class="waves-effect waves-cyan">
                      <i class="material-icons">view_list </i>
                      <span class="nav-text">Laporan Diterima</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="beranda.php?page=laporan/report_ditolak.php" class="waves-effect waves-cyan">
                      <i class="material-icons">view_list </i>
                      <span class="nav-text">Laporan Ditolak</span>
                    </a>
                </li>
