...
$registrasi = query("SELECT * FROM pendaftaran WHERE nik=$nik")[0];

if( isset($_POST["submit"]) ) {

    if( registrasi_update($_POST) >0  ) {
        echo "
            <script>
                ...
                <div class="row">
                  <div class="col s12 m12 l6">
                    <div class="card-panel">
                      <h4 class="header2">Data Diri</h4>
                      <div class="row">
                        <form action="" method="post" class="col s12" >
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="nik" type="text" value="<?= $registrasi["nik"]; ?>">
                              <label for="first_name">NIK</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="nama" type="text" value="<?= $registrasi["nama"]; ?>">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <label>Pass Photo <span class="text-danger">*</span></label>
                              <input class="form-control" type="file" name="photo" />
                              <p class="help-block">Kosongkan jika tidak mengubah gambar</p>
                              <img class="thumbnail" src="img/photo/<?= $registrasi["photo"]; ?>" height="120" />
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                            <select name="kelamin">
                                <option  name="kelamin" value="<?= $registrasi["kelamin"]; ?>" ><?= $registrasi["kelamin"]; ?></option>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="tmp_lahir" type="text" value="<?= $registrasi["tmp_lahir"]; ?>">
                              <label for="first_name">Tempat Lahir</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <label for="first_name">Tanggal Lahir</label> <br>
                              <input id="name" name="tgl_lahir" type="date" value="<?= $registrasi["tgl_lahir"]; ?>" >
                              </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <textarea name="alamat" id="alamat"  class="materialize-textarea"><?= $registrasi["alamat"]; ?></textarea>
                              <label for="alamat">Alamat</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="kota" type="text" value="<?= $registrasi["kota"]; ?>">
                              <label for="first_name">Kota</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="provinsi" type="text" value="<?= $registrasi["provinsi"]; ?>">
                              <label for="first_name">Provinsi</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="kode_pos" type="text" value="<?= $registrasi["kode_pos"]; ?>" >
                              <label for="first_name">Kode POS</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="no_hp" type="number" value="<?= $registrasi["no_hp"]; ?>" >
