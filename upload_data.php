                ...
                <div class="row">
                  <div class="col s12 m12 l6">
                    <div class="card-panel">
                      <h4 class="header2">Upload Berkas</h4>
                      <div class="row">
                        <form action="" method="post" class="col s12" >

                          <div class="row">
                            <div class="input-field col s12">
                             <input class="form-control" type="file" name="ktp" /> <br>
                              <label for="first_name">KTP</label>
                            </div>
                          </div>

                          <div class="row">
                            <div class="input-field col s12">
                             <input class="form-control" type="file" name="kk" /> <br>
                              <label for="first_name">Kartu Keluarga</label>
                            </div>
                          </div>
                       
                          <div class="row">
                            <div class="input-field col s12">
                             <input class="form-control" type="file" name="surat_sehat" /><br>
                              <label for="first_name">Surat Keterangan Sehat</label>
                            </div>
                          </div>
