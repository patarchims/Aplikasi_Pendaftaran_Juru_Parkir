...
$registrasi = query("SELECT * FROM registrasi WHERE nik=$nik")[0];

if( isset($_POST["submit"]) ) {

    if( registrasi_tambah($_POST) >0   ) {
        echo "
            <script>
              ...
              <li>
                <a href="javascript:void(0);" class="waves-effect waves-block waves-light profile-button" data-activates="profile-dropdown">
                  <span class="avatar-status avatar-online">
                    <img src="admin/images/avatar/avatar-7.png" alt="avatar">
                    <i></i>
                  </span>
                </a>
              </li>
            ...
            <li class="user-details cyan darken-2">
              <div class="row">
                <div class="col col s4 m4 l4">
                  <img src="admin/images/avatar/avatar-7.png" alt="" class="circle responsive-img valign profile-image cyan">
                </div>
                      ...
                      <div class="row">
                        <form action="" method="post" class="col s12" >
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                            <select name="kelamin">
                                <option  name="kelamin" value="" disabled selected>Pilih Jenis Kelamin</option>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="tmp_lahir" type="text" >
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              ...
                              <input id="name" name="tgl_lahir" type="date" >
                              </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="kota" type="text" >
                              <label for="first_name">Kota</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="provinsi" type="text" >
                              <label for="first_name">Provinsi</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="kode_pos" type="text" >
                              <label for="first_name">Kode POS</label>
                            </div>
                          </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <input id="name" name="no_hp" type="number" >
