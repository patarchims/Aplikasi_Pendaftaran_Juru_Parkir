...
if( isset($_POST["submit"]) ) {
    ...
    if( registrasi($_POST) >0 and  konfirmasi($_POST) >0) {
        echo "
            <script>
            document.location.href = 'registrasi_succes.php';
            </script>
        ";
    } else {
...
<html lang="en">
  ...
  <main>
    <center>
      ...
      <h5 class="indigo-text ">Daftar Juru Parkir</h5>
      <div class="section"></div>
 ...
 <!--Basic Form-->
                                    ...
                                    <div class="row">
                                        ...
                                        <input id="name" name="nik" type="text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <button name="submit" class="btn waves-effect waves-light center" type="submit" >Daftar
